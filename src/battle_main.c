...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    { TRAINER_CLASS_CHAMPION, 40 }, // 25
    { TRAINER_CLASS_YOUNGSTER, 0 }, // 4
    { TRAINER_CLASS_BUG_CATCHER, 0 }, // 3
    { TRAINER_CLASS_HIKER, 0 }, // 9
    { TRAINER_CLASS_BIRD_KEEPER, 0 }, // 6
    { TRAINER_CLASS_PICNICKER, 0 }, // 5
    { TRAINER_CLASS_SUPER_NERD, 0 }, // 6
    { TRAINER_CLASS_FISHERMAN, 0 }, // 9
    { TRAINER_CLASS_TEAM_ROCKET, 0 }, // 8
    { TRAINER_CLASS_LASS, 0 }, // 4
    { TRAINER_CLASS_BEAUTY, 0 }, // 18
    { TRAINER_CLASS_BLACK_BELT, 0 }, // 6
    { TRAINER_CLASS_CUE_BALL, 0 }, // 6
    { TRAINER_CLASS_CHANNELER, 0 }, // 8
    { TRAINER_CLASS_ROCKER, 0 }, // 6
    { TRAINER_CLASS_GENTLEMAN, 0 }, // 18
    { TRAINER_CLASS_BURGLAR, 0 }, // 22
    { TRAINER_CLASS_SWIMMER_M, 0 }, // 1
    { TRAINER_CLASS_ENGINEER, 0 }, // 12
    { TRAINER_CLASS_JUGGLER, 0 }, // 10
    { TRAINER_CLASS_SAILOR, 0 }, // 8
    { TRAINER_CLASS_COOLTRAINER, 0 }, // 9
    { TRAINER_CLASS_POKEMANIAC, 0 }, // 12
    { TRAINER_CLASS_TAMER, 0 }, // 10
    { TRAINER_CLASS_CAMPER, 0 }, // 5
    { TRAINER_CLASS_PSYCHIC, 0 }, // 5
    { TRAINER_CLASS_BIKER, 0 }, // 5
    { TRAINER_CLASS_GAMER, 0 }, // 18
    { TRAINER_CLASS_SCIENTIST, 0 }, // 12
    { TRAINER_CLASS_CRUSH_GIRL, 0 }, // 6
    { TRAINER_CLASS_TUBER, 0 }, // 1
    { TRAINER_CLASS_PKMN_BREEDER, 0 }, // 7
    { TRAINER_CLASS_PKMN_RANGER, 0 }, // 9
    { TRAINER_CLASS_AROMA_LADY, 0 }, // 7
    { TRAINER_CLASS_RUIN_MANIAC, 0 }, // 12
    { TRAINER_CLASS_LADY, 0 }, // 50
    { TRAINER_CLASS_PAINTER, 0 }, // 4
    { TRAINER_CLASS_TWINS, 0 }, // 3
    { TRAINER_CLASS_YOUNG_COUPLE, 0 }, // 7
    { TRAINER_CLASS_SIS_AND_BRO, 0 }, // 1
    { TRAINER_CLASS_COOL_COUPLE, 0 }, // 6
    { TRAINER_CLASS_CRUSH_KIN, 0 }, // 6
    { TRAINER_CLASS_SWIMMER_F, 0 }, // 1
    { TRAINER_CLASS_PLAYER, 0 }, // 1
    { TRAINER_CLASS_RS_LEADER, 40 }, // 25
    { TRAINER_CLASS_RS_ELITE_FOUR, 40 }, // 25
    { TRAINER_CLASS_RS_LASS, 0 }, // 4
    { TRAINER_CLASS_RS_YOUNGSTER, 0 }, // 4
    { TRAINER_CLASS_PKMN_TRAINER, 0 }, // 15
    { TRAINER_CLASS_RS_HIKER, 0 }, // 10
    { TRAINER_CLASS_RS_BEAUTY, 0 }, // 20
    { TRAINER_CLASS_RS_FISHERMAN, 0 }, // 10
    { TRAINER_CLASS_RS_LADY, 0 }, // 50
    { TRAINER_CLASS_TRIATHLETE, 0 }, // 10
    { TRAINER_CLASS_TEAM_AQUA, 0 }, // 5
    { TRAINER_CLASS_RS_TWINS, 0 }, // 3
    { TRAINER_CLASS_RS_SWIMMER_F, 0 }, // 2
    { TRAINER_CLASS_RS_BUG_CATCHER, 0 }, // 4
    { TRAINER_CLASS_SCHOOL_KID, 0 }, // 5
    { TRAINER_CLASS_RICH_BOY, 0 }, // 50
    { TRAINER_CLASS_SR_AND_JR, 0 }, // 4
    { TRAINER_CLASS_RS_BLACK_BELT, 0 }, // 8
    { TRAINER_CLASS_RS_TUBER_F, 0 }, // 1
    { TRAINER_CLASS_HEX_MANIAC, 0 }, // 6
    { TRAINER_CLASS_RS_PKMN_BREEDER, 0 }, // 10
    { TRAINER_CLASS_TEAM_MAGMA, 0 }, // 5
    { TRAINER_CLASS_INTERVIEWER, 0 }, // 12
    { TRAINER_CLASS_RS_TUBER_M, 0 }, // 1
    { TRAINER_CLASS_RS_YOUNG_COUPLE, 0 }, // 8
    { TRAINER_CLASS_GUITARIST, 0 }, // 8
    { TRAINER_CLASS_RS_GENTLEMAN, 0 }, // 20
    { TRAINER_CLASS_RS_CHAMPION, 0 }, // 50
    { TRAINER_CLASS_MAGMA_LEADER, 0 }, // 20
    { TRAINER_CLASS_BATTLE_GIRL, 0 }, // 6
    { TRAINER_CLASS_RS_SWIMMER_M, 0 }, // 2
    { TRAINER_CLASS_POKEFAN, 0 }, // 20
    { TRAINER_CLASS_EXPERT, 0 }, // 10
    { TRAINER_CLASS_DRAGON_TAMER, 0 }, // 12
    { TRAINER_CLASS_RS_BIRD_KEEPER, 0 }, // 8
    { TRAINER_CLASS_NINJA_BOY, 0 }, // 3
    { TRAINER_CLASS_PARASOL_LADY, 0 }, // 10
    { TRAINER_CLASS_BUG_MANIAC, 0 }, // 15
    { TRAINER_CLASS_RS_SAILOR, 0 }, // 8
    { TRAINER_CLASS_COLLECTOR, 0 }, // 15
    { TRAINER_CLASS_RS_PKMN_RANGER, 0 }, // 12
    { TRAINER_CLASS_MAGMA_ADMIN, 0 }, // 10
    { TRAINER_CLASS_RS_AROMA_LADY, 0 }, // 10
    { TRAINER_CLASS_RS_RUIN_MANIAC, 0 }, // 15
    { TRAINER_CLASS_RS_COOLTRAINER, 0 }, // 12
    { TRAINER_CLASS_RS_POKEMANIAC, 0 }, // 15
    { TRAINER_CLASS_KINDLER, 0 }, // 8
    { TRAINER_CLASS_RS_CAMPER, 0 }, // 4
    { TRAINER_CLASS_RS_PICNICKER, 0 }, // 4
    { TRAINER_CLASS_RS_PSYCHIC, 0 }, // 6
    { TRAINER_CLASS_RS_SIS_AND_BRO, 0 }, // 3
    { TRAINER_CLASS_OLD_COUPLE, 0 }, // 10
    { TRAINER_CLASS_AQUA_ADMIN, 0 }, // 10
    { TRAINER_CLASS_AQUA_LEADER, 0 }, // 20
    { TRAINER_CLASS_BOSS, 40 }, // 25
    { 0xFF, 5 },
};
